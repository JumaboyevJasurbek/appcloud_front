...
SECRET_KEY = 'django-insecure-%xkn@!rpfxu^+fet3_6^zguo)#9q3-3eyfflt^z@(+4_)m8)@4'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['billur.com', 'www.billur.com']
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "AppCloud Admin",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "AppCloud",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "AppCloud",

    # Logo to use for your site, must be present in static files, used for brand on top left
    "site_logo": "assets/img/logo-blue-light.png",
    ...
    "welcome_sign": "Welcome to the AppCloud",

    # Copyright on the footer
    "copyright": "Library Ltd AppcCloud",
    ...
    "user_avatar": "assets/img/logo-blue-light.png",
